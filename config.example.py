#!/usr/bin/env python3
"""
Fyers API Configuration — EXAMPLE TEMPLATE
==========================================
Copy this file to config.py and add your real credentials.
...
- Never commit config.py to a public GitHub repo with real credentials
...
CLIENT_ID = "XXXXXXXXXX-100"         # Your Fyers App ID
CLIENT_SECRET = "YOUR_SECRET_KEY"    # Your Fyers Secret Key
